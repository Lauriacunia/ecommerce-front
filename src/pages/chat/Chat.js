            ...
            <Grid container spacing={1}>
                <Box
                    ...
                    <FormControl variant="standard">
                        <Input id="component-simple" value={message} onChange={handleChangeMessage} placeholder='Ingrese su mensaje' sx={{ marginTop: '20px', width: '1000px'}} />
                        <Button variant="contained" onClick={sendMessage} sx={{ marginTop: '20px'}} >Enviar</Button>
                </FormControl>              
                </Box>
            </Grid>
